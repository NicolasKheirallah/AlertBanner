define([], function() {
  return {
    ...
    "CreateAlertContentTypeAlertDescription": "Einmalige Benachrichtigung direkt im Banner veröffentlichen.",
    "CreateAlertContentTypeTemplateDescription": "Konfiguration als wiederverwendbare Vorlage speichern.",
