define([], function () {
  return {
    ...
    EnableCopilotDescription:
      "Use Microsoft Copilot to draft alerts, translate content, and analyze governance compliance. Requires Copilot for Microsoft 365 license.",
    ...
    CopilotGovernanceButton: "Governance Check",
    CopilotGovernanceAnalysisTitle: "Governance Analysis Result",
    ...
    CopilotGovernanceStatusGreen: "Compliant",
    CopilotGovernanceStatusYellow: "Needs Review",
    CopilotGovernanceStatusRed: "Non-Compliant",
    CopilotGovernanceSummaryLabel: "Full Analysis",
  };
});
